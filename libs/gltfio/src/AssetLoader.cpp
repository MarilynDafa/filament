...
MaterialInstance* FAssetLoader::createMaterialInstance(const cgltf_material* inputMat) {
    auto pbr_metallic_roughness = inputMat->pbr_metallic_roughness;
    ...
    MaterialKey matkey {
        ...
        .baseColorUV = (uint8_t) pbr_metallic_roughness.base_color_texture.texcoord,
        .metallicRoughnessUV = (uint8_t) pbr_metallic_roughness.metallic_roughness_texture.texcoord,
